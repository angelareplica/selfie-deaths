...
module.exports = "/selfiedeaths.e035983b.csv";
...
var svg = d3.select('#force-chart').append('svg').attr('width', width + margin.left + margin.right).attr('height', height + margin.top + margin.bottom).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
...
},{}]},{},["../../../../.npm-global/lib/node_modules/parcel/src/builtins/hmr-runtime.js","force-chart.js"], null)
//# sourceMappingURL=/force-chart.359d85a3.map